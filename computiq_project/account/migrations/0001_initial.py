    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_rating', models.DecimalField(decimal_places=1, default=0, max_digits=6, verbose_name='total rating')),
                ('requests_accepted', models.IntegerField(default=0, verbose_name='number of requests')),
                ('requests_asked', models.IntegerField(default=0, verbose_name='requests asked number')),
